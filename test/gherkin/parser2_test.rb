...
module GherkinRuby
  ...
  Scenario: This is a while test
    Given a variable
    While a variable exists,
    it exists.
...
"""
    ...
    it 'generates a nice tree' do
      ...
      first_scenario.name.must_equal 'This is a while test'
      first_scenario.steps.first.keyword.must_equal 'Given'
      first_scenario.steps.first.name.must_equal 'a variable exists'
